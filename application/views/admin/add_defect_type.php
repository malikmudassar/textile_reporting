    ...
    <div class="layout-content-body">
        <div class="title-bar">
            <h1 class="title-bar-title" align="center">
                <span class="d-ib"><li class="icon icon-plus-circle"></li> Add Defect Type</span>
            </h1>
        </div>
                    ...
                    <form class="form form-horizontal" style="margin-top: 30px" method="POST">
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="panel panel-body text-center" data-toggle="match-height">
                                <button class="btn btn-primary" style="margin-left: 250px;padding: 6px 25px;!important;" type="submit">Add Defect Type</button>
                            </div>
                        </div>
                    </form>
                </div>
